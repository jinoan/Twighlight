...
def index(request):
    ...
    return render(request, 'twighlight/home.html', context)

@require_GET
def streamer(request):
    streamers = Streamer.objects.all()
    context = {'streamers': streamers}
    return render(request, 'twighlight/streamer.html', context)
...
def video(request, streamer_sid):
    ...
    return render(request, 'twighlight/video_list.html', context)
...
def chat(request, streamer_sid, video_vid):
    ...
    return render(request, 'twighlight/chat.html', context)
